...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to update new Customer & Account based on a account number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account based on a account number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
